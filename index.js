...
+ 'FN:Mr.Pato\n' // Nama
+ 'ORG:Mr.Pato-Bot;\n' // Nama bot
+ 'TEL;type=CELL;type=VOICE;waid=5491153251742:+54 9 11 5325-1742\n' // Nomor bot
+ 'END:VCARD' 
...
*/
            ...
            const linkfake = await axios.get(`https://freerestapi.herokuapp.com/api/v1/fakename?country=es`)
            const fakelink = linkfake.data
            (mek).reply(from, `😍 *¡AQUI ESTA TU PUTA IDENTIDAD NUEVA!* 😍\n\n🏷 *𝐍𝐨𝐦𝐛𝐫𝐞:* _${fakelink.name}_\n🎁 *𝐂𝐮𝐦𝐩𝐥𝐞:* _${fakelink.birthday}_\n🏠 *𝐃𝐢𝐫𝐞𝐜𝐜𝐢𝐨𝐧:* _${fakelink.address}_\n🏢 *𝐂𝐢𝐮𝐝𝐚𝐝:* _${fakelink.city}_\n🛣 *𝐑𝐞𝐠𝐢𝐨𝐧:* _${fakelink.region}_\n🌏 *𝐏𝐚𝐢𝐬:* _${fakelink.country}_\n✉️ *𝐂𝐨́𝐝𝐢𝐠𝐨 𝐏𝐨𝐬𝐭𝐚𝐥:* _${fakelink.zip}_\n📱 *𝐓𝐞𝐥𝐞𝐟𝐨𝐧𝐨:* _${fakelink.phone_number}_\n💻 *𝐆𝐦𝐚𝐢𝐥:* _${fakelink.email}_\n`, id)
